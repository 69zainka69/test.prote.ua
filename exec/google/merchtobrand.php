...
$output .= "<g:product_type>Главная > Офисная техника > Лазерные принтеры</g:product_type>";
...
$file=fopen("/var/www/prote/data/www/prote.ua/exec/google/merchbrand.xml", "w+");
fputs($file,$output);
fclose($file);


header("Location: https://prote.ua/exec/google/merchbrand.xml");
exit();
