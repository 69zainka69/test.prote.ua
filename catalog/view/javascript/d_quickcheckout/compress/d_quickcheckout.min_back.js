...
qc.Confirm = qc.Model.extend({
    ...
    recreateOrder: function() {
        $.post('index.php?route=d_quickcheckout/confirm/recreateOrder', '', function(data) {}, 'json');
    }
});
qc.ConfirmView = qc.View.extend({
    ...
    confirm: function() {
        ...
        if (ukrpost_address || flat_address) {
            ...
            $.post('index.php?route=d_quickcheckout/shipping_method/prepareuser', userdata, function(data) {
            }, 'json');
            // **************************************************************************
            // return;
        }
