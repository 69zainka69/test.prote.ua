  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <a data-toggle="tooltip" title="<?php echo $text_title_seourl; ?>" class="btn btn-danger cache" data-type="seourl"><i class="fa fa-code"></i> <?php echo $button_seourl; ?></a>
        <a data-toggle="tooltip" title="<?php echo $text_title_price; ?>" class="btn btn-danger cache" data-type="price"><i class="fa fa-code"></i> <?php echo $button_price; ?></a>
