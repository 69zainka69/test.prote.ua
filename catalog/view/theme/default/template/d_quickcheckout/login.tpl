...
-->
<div class="qc-step" data-col="1" data-row="4">
...
<% }else{ %>
	...
	<div class="<%= parseInt(model.config.option.login.display) ? '' : 'hidden' %>">
		...
		<div class="panel panel-default ">
			<div class="or"><span><?php echo $text_or; ?></span></div>
			<div class="panel-heading">
				<span class="icon">
					<i class="<%= model.config.icon %>"></i>
				</span>
				<span class="text"><?php echo $text_enter; ?></span>
			</div>
				...
				<form id="login_form">
					<div class="">
						...
						<div class="form-group col-sm-12">
							...
							<button id="button_login" class="button"><?php echo $button_login; ?></button>
						</div>
					</div>
				</form>
