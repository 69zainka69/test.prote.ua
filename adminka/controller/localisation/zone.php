...
class ControllerLocalisationZone extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['keyword'])) {
            ...
            $data['keyword'] = $zone_info['keyword'];
        } else {
            $data['keyword'] = '';
        }
	...
	protected function validateForm() {
        ...
        if (utf8_strlen($this->request->post['keyword']) > 0) {
            ...
            if ($url_alias_info && isset($this->request->get['zone_id']) && $url_alias_info['query'] != 'city=' . $this->request->get['zone_id']) {
                $this->error['keyword'] = sprintf($this->language->get('error_keyword'));
            }

            if ($url_alias_info && !isset($this->request->get['zone_id'])) {
                $this->error['keyword'] = sprintf($this->language->get('error_keyword'));
            }
