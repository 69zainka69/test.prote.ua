            ...
            if($phone) {
                ...
                if ($this->config->get('ordercallback_send_notification_to_email')) {
                    ...
                    try {
                        ...
                        //$mail->setTo('alex@patronservice.ua, Alyona.Rozhankovskaya@vm.ua, Victoriya.Kushnirenko@vm.ua, Dmitro.Bliznyk@vm.ua, Maxim.Kovalchuk@vm.ua, nata@patronservice.ua, Olga.Gumenyuk@vm.ua, info@prote.ua');
