<?php
class Mail {
	protected $to = 'info@prote.com.ua';
	protected $from = 'info@prote.com.ua';
	protected $sender;
	protected $reply_to;
	protected $subject;
	protected $text;
	...
	public function setTo($to='info@prote.com.ua') {
		$this->to = $to;
	}

	public function setFrom($from='info@prote.com.ua') {
		$this->from = $from;
	}
