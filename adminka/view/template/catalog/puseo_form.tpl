        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-brand">Бренд:</label>
              <div class="col-sm-10">
                <select name="brand_id" id="input-brand" class="form-control">
                  <option value="0"><?php echo $text_none; ?></option>
                  <?php foreach ($brands as $brand) { ?>
                  <?php if (strtolower($brand['brand']) ==$brand_id) { ?>
                  <option value="<?php echo strtolower($brand['brand']); ?>" selected="selected"><?php echo $brand['brand']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo strtolower($brand['brand']); ?>"><?php echo $brand['brand']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="category_id" id="input-category" class="form-control">
                  ...
                  <option value="<?php echo $id; ?>" selected="selected"><?php echo $cat; ?></option>
                  <?php } else { ?>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="puseo_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($puseo_description[$language['language_id']]) ? $puseo_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="puseo_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($puseo_description[$language['language_id']]) ? $puseo_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-title<?php echo $language['language_id']; ?>"><?php echo $entry_meta_title; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="puseo_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($puseo_description[$language['language_id']]) ? $puseo_description[$language['language_id']]['meta_title'] : ''; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-h1<?php echo $language['language_id']; ?>"><?php echo $entry_meta_h1; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="puseo_description[<?php echo $language['language_id']; ?>][meta_h1]" value="<?php echo isset($puseo_description[$language['language_id']]) ? $puseo_description[$language['language_id']]['meta_h1'] : ''; ?>" placeholder="<?php echo $entry_meta_h1; ?>" id="input-meta-h1<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-description<?php echo $language['language_id']; ?>"><?php echo $entry_meta_description; ?></label>
                    <div class="col-sm-10">
                      <textarea name="puseo_description[<?php echo $language['language_id']; ?>][meta_description]" rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($puseo_description[$language['language_id']]) ? $puseo_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword; ?></label>
                    <div class="col-sm-10">
                      <textarea name="puseo_description[<?php echo $language['language_id']; ?>][meta_keyword]" rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($puseo_description[$language['language_id']]) ? $puseo_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                    </div>
                  </div>
                </div>
                <?php } ?>
...
$('select[name=\'filter_group_id\']').on('change', function(){ 
   $('#filter_id').load('index.php?route=catalog/puseo/getFilters&token=<?php echo $token; ?>&filter_group_id=' +  encodeURIComponent(this.value));

/*
  $.ajax({
      url: 'index.php?route=catalog/puseo/getFilters&token=<?php echo $token; ?>&filter_group_id=' +  encodeURIComponent(this.value),
      dataType: 'json',
...
$('#filter_id').on('click','input',function(){
  ...
  $('#puseo_filters').append('<div id="puseo_filters' + $(this).val() + '"><i class="fa fa-minus-circle"></i> ' +  $(this).attr('data-name') + '<input type="hidden" name="puseo_filters[]" value="' + $(this).val() + '" /></div>');
  //$(this).val();
...
$('input[name=\'filter\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('#puseo_filters' + item['value']).remove();

    $('#puseo_filters').append('<div id="puseo_filters' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="puseo_filters[]" value="' + item['value'] + '" /></div>');
  }
});

$('#puseo_filters').delegate('.fa-minus-circle', 'click', function() {
  $(this).parent().remove();
});
