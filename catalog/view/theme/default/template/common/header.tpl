...
<?php /* if(!isset($_COOKIE['city_UA']) || !isset($_COOKIE['city_RU'])){
...
$ip = $m[1];
    ...
    setcookie("city_RU", $query['city'], time()+3600);
}*/ ?>
<!DOCTYPE html>
        ...
        .then(function(registrations){
          registration.unregister();
            for(let registration of registrations){
              //registration.unregister();
              if(registration.active.scriptURL == 'https://prote.ua/sw.js'){registration.unregister(); }
              //console.log(registration);
              if(registration.active.scriptURL == 'sw2.js'){registration.unregister(); }
            }
        });
}*/ ?>
if ('serviceWorker' in navigator){navigator.serviceWorker.register('/sw.js').then(function(registration){}).catch(function(error){});}
</script>

<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0], j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src= 'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KD9VV7G');</script>
<?php
...
<meta name='yandex-verification' content='7382c34b21840241' />
...
<style><?php echo file_get_contents(DIR_APPLICATION.'view/js/menu.css'); ?>
...
}@media(max-width:992px){#slider{width:100%;padding-top:0;} #slider .info{display:none}}@media(max-width:768px){#slider .content{padding-bottom:0;}}</style>
<?php } ?>
<?php if ($route=='checkout/checkout'){ ?>
<script src="/catalog/view/js/jquery-3.5.1.min.js"></script>
<?php } ?>
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-954436888"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'AW-954436888');
</script>
</head>
        ...
        <div class="row">
          <div class="top-panel__container">
            ...
            <div class="top-panel__city">
              <span class="top-panel__city-name" data-city>
                <?php 
                if(isset($_COOKIE['city_UA']) || isset($_COOKIE['city_RU'])){
                if (isset($_COOKIE['city_UA']) && $lang == 'uk' && urldecode($_COOKIE['city_UA'])) {
                   echo urldecode($_COOKIE['city_UA']); 
                  } elseif(isset($_COOKIE['city_RU']) && $lang == 'ru' && urldecode($_COOKIE['city_RU'])) { echo urldecode($_COOKIE['city_RU']);
                } else {
                    echo $text_select_city;
                  }}else{ echo $text_select_city;}
                  ?>
                  </span>
            </div>
            <div class="top-panel__menu">
              ...
              <a href="<?php echo $langpref;?>/contacts.html" title="<?php echo $text_contacts; ?>" class="top-panel__link"><?php echo $text_contacts; ?></a></div>
          ...
          <div class="lang-select">
            <div class="lang-select__item"><a href="<?php echo  $current_url; ?>" class="top-panel__lang-link">Укр</a></div></div><? } ?></div><div class="top-panel__login">
              <?php if ($logged){ ?>
              ...
              <?php } ?>
            </div></div></div></div></div><div class="header"><div class="container"><div class="row"><div class="header__catalog"><div class="header__menu-icon">
          <?php echo file_get_contents(DIR_IMAGE.'/ico/menu.svg');?>
        </div><div class="header__catalog-title">Каталог</div></div><div class="header__search"><?php echo $search; ?></div>
      <div class="callback"><a href="" class="btn-modal" data-modal="modal-callback" aria-label="Обратный звонок">
          <span class="svg"><?php echo file_get_contents(DIR_IMAGE.'/ico/720-callback.svg');?></span></a></div>
      <div class="cart"><a href ="<?php echo $langpref;?>/cart/"><?php echo $cart; ?></a></div></div></div></div>
...
<div class="container">
    <svg style="display:none;height:0;width:0;"></svg>
    <div class="row">
...
<?php if ($route!='common/home'){ ?>
<style>.breadcrumb{margin-bottom: 11px !important; margin-top: 8px !important;}
...
.breadcrumb li:before{content:'/';margin:0px 1px 0 5px;display:inline-block;vertical-align:middle;font-size:14px;color:#999;line-height:1;}</style>
<?php } ?>
<?php if ($route!='checkout/checkout'){ ?>
