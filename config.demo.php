...
define('HTTP_SERVER', 'http://prote.demo.webbylab.com/');
define('HTTPS_SERVER', 'http://prote.demo.webbylab.com/');
define('HTTPS_SERVER_ADMIN', 'http://prote.demo.webbylab.com/adminka/');
