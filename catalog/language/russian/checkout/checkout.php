...
$_['text_your_address']              = 'Вид деятельности';
$_['text_your_password']             = 'Пароль';
$_['text_agree']                     = 'Нажав кнопку "Потдвердить заказ" Вы автоматически соглашаетесь с документом<br><a href="%s" class="agree"><b>%s</b></a>';
...
$_['text_month']                     = 'месяц';
$_['text_year']                      = 'год';
$_['text_no_call']                      = 'Оформление заказа без звонка менеджера';
$_['text_no_call_tooltip']           = 'Если у менеджера не будет уточнений по заказу, мы отправим товар без звонка!';
