...
class ControllerModulePPLogin extends Controller {
	...
	public function login() {
		...
		if ($this->customer->isLogged()) {
			echo '<script>window.opener.location = "' . $this->url->link('account/account', '', 'SSL') . '"; window.close();</script>';
		}
		...
		if (!isset($this->request->get['code'])) {
			...
			echo '<script>window.opener.location = "' . $this->url->link('account/login', '', 'SSL') . '"; window.close();</script>';
		} else {
