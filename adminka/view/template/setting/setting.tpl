                ...
                <?php foreach ($languages as $language) { ?>
                  <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="config_meta_title[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($config_meta_title[$language['language_id']]['title']) ? $config_meta_title[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea name="config_meta_description[<?php echo $language['language_id']; ?>][title]" rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($config_meta_description[$language['language_id']]['title']) ? $config_meta_description[$language['language_id']]['title'] : ''; ?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword; ?></label>
                        <div class="col-sm-10">
                          <textarea name="config_meta_keyword[<?php echo $language['language_id']; ?>][title]" rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($config_meta_keyword[$language['language_id']]['title']) ? $config_meta_keyword[$language['language_id']]['title'] : ''; ?></textarea>
                        </div>
                      </div>
                   </div>   
                <?php } ?>
