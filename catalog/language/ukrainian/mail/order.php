...
$_['text_new_greeting']         = 'Дякуємо Вам за оформлення замовлення у нашому інтернет-магазині <a style="color:#00AEEF;" href="https://prote.ua/ua/">Prote.ua</a>! Ваше замовлення отримане та опрацьовується нашими співробітниками. Очікуйте, будь ласка, дзвінка від менеджера найближчим часом.
';
...
$_['text_new_no_clall'] = 'Оформлення замовлення без дзвінка менеджера:';
$_['text_new_company'] = 'Назва підприємства:';
$_['text_new_company_name'] = 'Код ЄДРПОУ:';
$_['text_new_no_call_tooltip'] = 'Якщо у менеджера не буде уточнень по замовленню, ми відправимо товар без дзвінка!';
