...
class ControllerAccountAddress extends Controller {
	...
	protected function getList() {
		...
		$data['text_edit1'] = $this->language->get('text_edit1');
		...
		$data['text_address_defautl'] = $this->language->get('text_address_defautl');
		...
		$data['defautl_address_id'] = $this->customer->getAddressId();
	...
	protected function getForm() {
		...
		$data['edit'] = $this->url->link('account/edit', '', 'SSL');
		$data['password1'] = $this->url->link('account/password', '', 'SSL');
		$data['address'] = $this->url->link('account/address', '', 'SSL');
		$data['order'] = $this->url->link('account/order', '', 'SSL');
		$data['newsletter'] = $this->url->link('account/newsletter', '', 'SSL');
		$data['logout'] = $this->url->link('account/logout', '', 'SSL');
		
	    $data['firstname1'] =$this->customer->getFirstname();
	    $data['lastname1']  =$this->customer->getLastname();
