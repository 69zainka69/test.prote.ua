...
$_['text_new_greeting']         = 'Благодарим вас за оформление заказа в нашем интернет-магазине PROTE.<br/>Ваш заказ принят. Ожидайте, пожалуйста, звонка менеджера.';
...
$_['text_new_no_clall'] = 'Оформление заказа без звонка менеджера:';
$_['text_new_no_call_tooltip'] = 'Если у менеджера не будет уточнений по заказу, мы отправим товар без звонка!';
$_['text_new_company'] = 'Название предприятия:';
$_['text_new_company_name'] = 'Код ЕГРПОУ:';
