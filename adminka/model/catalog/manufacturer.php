...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', 
			
			filter_ids = '" . $this->db->escape($data['filter_ids']) . "', 
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', 
	...
	public function getFilterManufacturers($data) {

		//$sql = "SELECT DISTINCT `text` FROM " . DB_PREFIX . "product_attribute WHERE attribute_id =1 AND language_id = 1";
		$sql = "SELECT * FROM " . DB_PREFIX . "filter f LEFT JOIN " . DB_PREFIX . "filter_description fd ON(f.filter_id = fd.filter_id) 
		WHERE 
		(fd.filter_group_id = 1 OR
		fd.filter_group_id = 4949)
