...
(function(h, k, m, t) {
    "undefined" == typeof h.easyXDM && function(a, b, c, d, e, f) {
        function h(a, b) { var g = typeof a[b]; return "function" == g || !("object" != g || !a[b]) || "unknown" == g }

        function k() {
            if (!A(m.plugins) && "object" == typeof m.plugins["Shockwave Flash"]) {
                var a = m.plugins["Shockwave Flash"].description;
                a && !A(m.mimeTypes) && m.mimeTypes["application/x-shockwave-flash"] && m.mimeTypes["application/x-shockwave-flash"].enabledPlugin && (F = a.match(/\d+/g))
            }
            if (!F) try {
        ...
        function p(a, b) { G ? a.call(b) : O.push(function() { a.call(b) }) }
        ...
        function B(a, b) {
            var g = "",
                c = a.indexOf("#"); - 1 !== c && (g = a.substring(c), a = a.substring(0, c));
            c = [];
        ...
        function u(a, b, c) {
            ...
            for (g in b)
                if (b.hasOwnProperty(g))
                    if (g in a) { var d = b[g]; "object" === typeof d ? u(a[g], d, c) : c || (a[g] = b[g]) } else a[g] = b[g];
            return a
        }
        ...
        function E(a) {
            ...
            a.container || (u(c.style, { position: "absolute", top: "-2000px", left: "0px" }), a.container = b.body);
            g = a.props.src;
        ...
        function aa(g) {
            ...
            Y = g.hash || !1;
            g.props || (g.props = {});
            if (g.isHost) g.remote = K(g.remote), g.channel = g.channel || "default" + Z++, g.secret = Math.random().toString(16).substring(2), A(d) && (d = r(c.href) == r(g.remote) ? "4" : h(a, "postMessage") || h(b, "postMessage") ? "1" : g.swf && h(a, "ActiveXObject") &&
                k() ? "6" : "Gecko" === m.product && "frameElement" in a && -1 == m.userAgent.indexOf("WebKit") ? "5" : g.remoteHelper ? "2" : "0");
            else {
                ...
                if (f = g.acl) {
                    a: {
                        ...
                        for (var H, L = f.length; L--;)
                            if (H = f[L], H = new RegExp("^" == H.substr(0, 1) ? H : "^" + H.replace(/(\*)/g, ".$1").replace(/\?/g, ".") + "$"), H.test(e)) { f = !0; break a }
                        f = !1
                    }
                    f = !f
                }
            ...
            switch (d) {
                case "0":
                    u(g, { interval: 100, delay: 2E3, useResize: !0, useParent: !1, usePolling: !1 }, !0);
                    if (g.isHost) {
                        if (!g.local) {
                            d = c.protocol + "//" + c.host;
                            var q = b.body.getElementsByTagName("img");
                            for (e = q.length; e--;)
                                if (f = q[e], f.src.substring(0, d.length) === d) { g.local = f.src; break }
                            g.local || (g.local = a)
                        }
                        d = { xdm_c: g.channel, xdm_p: 0 };
                        g.local === a ? (g.usePolling = !0, g.useParent = !0, g.local = c.protocol + "//" + c.host + c.pathname + c.search, d.xdm_e = g.local, d.xdm_pa = 1) : d.xdm_e = K(g.local);
                        g.container && (g.useResize = !1,
                            d.xdm_po = 1);
                        g.remote = B(g.remote, d)
                    } else u(g, { channel: x.xdm_c, remote: x.xdm_e, useParent: !A(x.xdm_pa), usePolling: !A(x.xdm_po), useResize: g.useParent ? !1 : g.useResize });
                    q = [new l.stack.HashTransport(g), new l.stack.ReliableBehavior({}), new l.stack.QueueBehavior({ encode: !0, maxLength: 4E3 - g.remote.length }), new l.stack.VerifyBehavior({ initiate: g.isHost })];
                    break;
                case "1":
                ...
                case "2":
                    ...
                    q = [new l.stack.NameTransport(g), new l.stack.QueueBehavior,
        ...
        function ba(a) {
            for (var b, c = {
                    incoming: function(a, b) { this.up.incoming(a, b) },
                    outgoing: function(a, b) { this.down.outgoing(a, b) },
                    callback: function(a) { this.up.callback(a) },
                    init: function() { this.down.init() },
                    destroy: function() { this.down.destroy() }
                }, g = 0, d = a.length; g < d; g++) b = a[g], u(b, c, !0), 0 !== g && (b.down = a[g - 1]), g !== d - 1 && (b.up = a[g + 1]);
            return b
        }
        ...
        if (h(a, "addEventListener")) {
            var C = function(a, b, c) { a.addEventListener(b, c, !1) };
            var M = function(a, b, c) {
                a.removeEventListener(b,
                    c, !1)
            }
        } else if (h(a, "attachEvent")) C = function(a, b, c) { a.attachEvent("on" + b, c) }, M = function(a, b, c) { a.detachEvent("on" + b, c) };
        else throw Error("Browser not supported");
        var G = !1,
            O = [];
        if ("readyState" in b) {
            var V = b.readyState;
            G = "complete" == V || ~m.userAgent.indexOf("AppleWebKit/") && ("loaded" == V || "interactive" == V)
        } else G = !!b.body;
        if (!G) {
            if (h(a, "addEventListener")) C(b, "DOMContentLoaded", w);
            else if (C(b, "readystatechange", function() { "complete" == b.readyState && w() }), b.documentElement.doScroll && a === top) {
                var ca = function() {
                    if (!G) {
                        try { b.documentElement.doScroll("left") } catch (g) {
                            d(ca,
                                1);
                            return
                        }
        ...
        var x = function(a) { a = a.substring(1).split("&"); for (var b = {}, c, g = a.length; g--;) c = a[g].split("="), b[c[0]] = e(c[1]); return b }(/xdm_e=/.test(c.search) ? c.search : c.hash),
            W = function() {
                var a = {},
                    b = { a: [1, 2, 3] };
                ...
                "function" === typeof String.prototype.evalJSON &&
                    (b = '{"a":[1,2,3]}'.evalJSON(), b.a && 3 === b.a.length && 3 === b.a[2] && (a.parse = function(a) { return a.evalJSON() }));
                return a.stringify && a.parse ? (W = function() { return a }, a) : null
            };
        u(l, {
            version: "2.4.19.0",
            query: x,
        ...
        l.DomHelper = { on: C, un: M, requiresJSON: function(c) { "object" == typeof a.JSON && a.JSON || b.write('<script type="text/javascript" src="' + c + '">\x3c/script>') } };
        (function() {
            var a = {};
            l.Fn = {
                set: function(b, c) { a[b] = c },
                get: function(b, c) {
        ...
        l.Socket = function(a) {
            var b = ba(aa(a).concat([{ incoming: function(b, c) { a.onMessage(b, c) }, callback: function(b) { if (a.onReady) a.onReady(b) } }])),
                c = r(a.remote);
        ...
        l.Rpc = function(a, b) {
            ...
            var d = ba(aa(a).concat([new l.stack.RpcBehavior(this, b), { callback: function(b) { if (a.onReady) a.onReady(b) } }]));
            this.origin = r(a.remote);
            this.destroy = function() { d.destroy() };
            d.init()
        };
        l.stack.SameOriginTransport = function(a) {
            ...
            return b = {
                ...
                destroy: function() { g && (g.parentNode.removeChild(g), g = null) },
                onDOMReady: function() {
                    e = r(a.remote);
                    a.isHost ? (u(a.props, {
                        src: B(a.remote, { xdm_e: c.protocol + "//" + c.host + c.pathname, xdm_c: a.channel, xdm_p: 4 }),
                        name: y + a.channel + "_provider"
                    }), g = E(a), l.Fn.set(a.channel, function(a) {
                        f = a;
                        d(function() { b.up.callback(!0) }, 0);
                        return function(a) { b.up.incoming(a, e) }
                    })) : (f = t().Fn.get(a.channel)(function(a) { b.up.incoming(a, e) }), d(function() { b.up.callback(!0) }, 0))
                },
                init: function() { p(b.onDOMReady, b) }
            }
        };
        l.stack.FlashTransport = function(a) {
            function g(a, b) { d(function() { h.up.incoming(a, L) }, 0) }
            ...
            function e(c) {
                ...
                a.swfContainer ? I = "string" == typeof a.swfContainer ? b.getElementById(a.swfContainer) : a.swfContainer : (I = b.createElement("div"), u(I.style, T && a.swfNoThrottle ? { height: "20px", width: "20px", position: "fixed", right: 0, top: 0 } : { height: "1px", width: "1px", position: "absolute", overflow: "hidden", right: 0, top: 0 }), b.body.appendChild(I));
                var e = "callback=flash_loaded" + f(c.replace(/[\-.]/g,
                    "_")) + "&proto=" + R.location.protocol + "&domain=" + f(R.location.href.match(P)[3]) + "&port=" + f(R.location.href.match(P)[4] || "") + "&ns=" + f(J);
            ...
            return h = {
                ...
                destroy: function() {
                    try { q.destroyChannel(a.channel) } catch (ka) {}
                    q = null;
                    k && (k.parentNode.removeChild(k), k = null)
                },
                onDOMReady: function() {
                    L = a.remote;
                    l.Fn.set("flash_" + a.channel + "_init", function() { d(function() { h.up.callback(!0) }) });
                    ...
                    var b = a.swf.match(P)[3],
                        f = function() {
                            ...
                            a.isHost && (T && a.swfNoThrottle && u(a.props, { position: "fixed", right: 0, top: 0, height: "20px", width: "20px" }), u(a.props, { src: B(a.remote, { xdm_e: r(c.href), xdm_c: a.channel, xdm_p: 6, xdm_s: a.secret }), name: y + a.channel + "_provider" }), k = E(a))
                        };
                    l.stack.FlashTransport[b] && l.stack.FlashTransport[b].init ? f() : l.stack.FlashTransport[b] ? l.stack.FlashTransport[b].queue.push(f) : (l.stack.FlashTransport[b] = { queue: [f] }, e(b))
                },
                init: function() { p(h.onDOMReady, h) }
            }
        };
                ...
                return f = {
                    ...
                    onDOMReady: function() {
                        k =
                            r(b.remote);
                        if (b.isHost) {
                            var q = function(c) { c.data == b.channel + "-ready" && (h = "postMessage" in e.contentWindow ? e.contentWindow : e.contentWindow.document, M(a, "message", q), C(a, "message", g), d(function() { f.up.callback(!0) }, 0)) };
                            C(a, "message", q);
                            u(b.props, { src: B(b.remote, { xdm_e: r(c.href), xdm_c: b.channel, xdm_p: 1 }), name: y + b.channel + "_provider" });
                            e = E(b)
                        } else C(a, "message", g), h = "postMessage" in a.parent ? a.parent : a.parent.document, h.postMessage(b.channel + "-ready", k), d(function() { f.up.callback(!0) }, 0)
                    },
                    init: function() {
                        p(f.onDOMReady,
                            f)
        ...
        l.stack.FrameElementTransport = function(g) {
            ...
            return f = {
                ...
                destroy: function() { e && (e.parentNode.removeChild(e), e = null) },
                onDOMReady: function() {
                    k = r(g.remote);
                    g.isHost ? (u(g.props, { src: B(g.remote, { xdm_e: r(c.href), xdm_c: g.channel, xdm_p: 5 }), name: y + g.channel + "_provider" }), e = E(g), e.fn = function(a) {
                        delete e.fn;
                        h = a;
                        d(function() { f.up.callback(!0) }, 0);
                        return function(a) { f.up.incoming(a, k) }
                    }) : (b.referrer && r(b.referrer) != x.xdm_e && (a.top.location = x.xdm_e),
                        h = a.frameElement.fn(function(a) { f.up.incoming(a, k) }), f.up.callback(!0))
                },
                init: function() { p(f.onDOMReady, f) }
            }
        };
        l.stack.NameTransport = function(a) {
            function b(b) { k.contentWindow.sendMessage(b, a.remoteHelper + (h ? "#_3" : "#_2") + a.channel) }

            function c() { h ? 2 !== ++v && h || e.up.callback(!0) : (b("ready"), e.up.callback(!0)) }

            function f(a) { e.up.incoming(a, N) }

            function g() { D && d(function() { D(!0) }, 0) }
            ...
            return e = {
                ...
                onDOMReady: function() {
                    ...
                    N = r(a.remote);
                    a.local = K(a.local);
                    h ? (l.Fn.set(a.channel, function(b) { h && "ready" === b && (l.Fn.set(a.channel, f), c()) }), da = B(a.remote, { xdm_e: a.local, xdm_c: a.channel, xdm_p: 2 }), u(a.props, { src: da + "#" + a.channel, name: y + a.channel + "_provider" }), n = E(a)) : (a.remoteHelper = a.remote, l.Fn.set(a.channel, f));
                    var b = function() {
                        var f = k || this;
                        M(f, "load", b);
                ...
                init: function() { p(e.onDOMReady, e) }
            }
        };
        l.stack.HashTransport = function(b) {
            function c() {
                if (n) {
                    ...
                    b && b != k && (k = b, f.up.incoming(k.substring(k.indexOf("_") + 1), N))
                }
            }
                    ...
                    if (g) {
                        ...
                        if (D) b.onLoad = function() {
                            ...
                            var q = 0,
                                z = b.delay / 50;
                            (function ia() {
                                if (++q > z) throw Error("Unable to reference listenerwindow");
                                try { n = v.contentWindow.frames[y + b.channel + "_consumer"] } catch (S) {}
                                n ? (e = setInterval(c, h), f.up.callback(!0)) : d(ia, 50)
                            })()
                        }
                        v = E(b)
                    } else n = a, e = setInterval(c, h), D ? (v = parent, f.up.callback(!0)) :
                        (u(b, { props: { src: b.remote + "#" + b.channel + new Date, name: y + b.channel + "_consumer" }, onLoad: function() { f.up.callback(!0) } }), v = E(b))
                },
                init: function() { p(f.onDOMReady, f) }
            }
        };
        l.stack.ReliableBehavior = function(a) {
            ...
            return b = {
                incoming: function(a, e) {
                    ...
                    a = a.substring(h + 1);
                    k[0] == d && (g = "", c && c(!0));
                    0 < a.length && (b.down.outgoing(k[1] + "," + d + "_" + g, e), f != k[1] && (f = k[1], b.up.incoming(a, e)))
                },
            ...
            function b() {
                if (a.remove && 0 === g.length) fa(c);
                    ...
                    c.down.outgoing(f.data, f.origin, function(a) {
                        h = !1;
                        f.callback && d(function() { f.callback(a) }, 0);
                        b()
                    })
                }
            }
            ...
            return c = {
                ...
                outgoing: function(d, e, h) {
                    ...
                    if (v) {
                        ...
                        for (; n = k.shift();) g.push({ data: k.length + "_" + n, origin: e, callback: 0 === k.length ? h : null })
        ...
        l.stack.VerifyBehavior = function(a) {
            ...
            var c, d, f;
            return c = { incoming: function(e, g) { var h = e.indexOf("_"); - 1 === h ? e === d ? c.up.callback(!0) : f || (f = e, a.initiate || b(), c.down.outgoing(e)) : e.substring(0, h) === f && c.up.incoming(e.substring(h + 1), g) }, outgoing: function(a, b, f) { c.down.outgoing(d + "_" + a, b, f) }, callback: function(c) { a.initiate && b() } }
        };
            ...
            function d(a, b) {
                ...
                return function() {
                    ...
                    if (0 < f && "function" === typeof arguments[f - 1]) {
                        ...
                        } else g = { success: arguments[f - 1] }, e.params = d.call(arguments, 0, f - 1);
                        k["" + ++h] = g;
                        e.id = h
    ...
    "undefined" != typeof h.uLogin && h.uLogin.uLoginHost || (Array.prototype.indexOf || (Array.prototype.indexOf = function(a) {
        ...
        String.prototype.trim || (String.prototype.trim = function() { return this.replace(/^\s+|\s+$/g, "") }), "undefined" === typeof h.console && (h.console = { log: function() {}, error: function() {}, info: function() {}, assert: function() {} }), h.uLogin = {
            uLoginHost: function(a) {
                var b;
                for (b in a)
                    if (b in a && a[b].src && /^https?:\/\/(.*?)\/js\/ulogin\.js/.test(a[b].src)) { var c = a[b].src.match(/^https?:\/\/([^/]+)/)[1].replace(/^www\./, ""); break }
            ...
            rc: !1,
            page: null,
            altway: function(a) { a = a.toLowerCase(); return !!/iPhone|iPad/i.test(a) }(m.userAgent || m.vendor || h.opera),
            ...
            ppi: null,
            authSocket: !1,
            availableParams: { id: 1, redirect_uri: 1, page: 1, callback: 1, fields: 1, force_fields: 1, popup_css: 1, optional: 1, protocol: 1, host: 1, lang: 1, verify: 1, sort: 1, othprov: 1, providers: 1, altway: 1, m: 1, icons_32: 1, icons_16: 1 },
            cancelClick: !1,
            ...
            init: function(a) {
                if (k.body) {
                    ...
                    uLogin.timeouts.check_widgets = t(function z() {
                        ...
                        uLogin.timeouts.check_widgets = t(z,
                            300)
                    }, 30);
                ...
                } else t(function() { uLogin.init() }, 20);
                this.callbackReceived()
            },
            onMessage: function(a) {
                a.origin == "https://" + uLogin.uLoginHost && a.data && a.data.mine && a.data.func && ("object" === typeof a.data.func && (a.data.func = a.data.func[0]), "to_window" === a.data.func ? (src = uLogin.buildUrl(a.data.args[2], { fields: a.data.args[0], filled: a.data.args[1], set: encodeURIComponent("{window:1}") }), console.log(src), uLogin.loadWindow(src)) : h[a.data.func] && h[a.data.func].apply(uLogin, a.data.args || []))
            },
            get: function(a) { return k.getElementById(a) },
            exists: function(a) { return "undefined" != typeof a },
            add: function(a, b, c) {
                a.addEventListener ? a.addEventListener(b, function(d) { "click" === b && uLogin.cancelClick || c(a, d) }, !1) : a.attachEvent ? a.attachEvent("on" + b, function(d) { "click" === b && uLogin.cancelClick || c(a, d) }) : a["on" + b] = function(d) {
                    "click" ===
                    b && uLogin.cancelClick || c(a, d)
                };
                "click" === b && (this.add(a, "touchstart", this.touchStart), this.add(a, "touchend", function(a, b) { return function(c, d) { uLogin.cancelClick || (uLogin.cancelClick = !0, b.call(this, a, d)) } }(a, c)))
            },
            touchStart: function() { uLogin.cancelClick = !1 },
            touchMove: function() { uLogin.cancelClick = !0 },
            is_encoded: function(a) { return decodeURIComponent(a) != a },
            genID: function() {
                for (var a = new Date, b = a.getTime() + Math.floor(1E5 * Math.random()); this.get("ul_" + b);) b = a.getTime() + Math.floor(1E5 * Math.random());
                return "ul_" + b
            },
            show: function(a) { this.exists(a) && (a.style.display = "block") },
            hide: function(a) { a && this.exists(a) && (a.style.display = "none") },
            parse: function(a) {
                var b = {};
                if (!a) return b;
            ...
            scrollTop: function() { return h.pageYOffset || k.documentElement.scrollTop || k.body.scrollTop },
            scrollLeft: function() {
                return h.pageXOffset ||
                    k.documentElement.scrollLeft || k.body.scrollLeft
            },
            dialogHeight: function() { return 358 },
            dialogWidth: function() { return 564 },
            ...
            clientHeight: function() {
                var a = 0;
                "[object Opera]" == Object.prototype.toString.call(h.opera) && 9.5 > h.parseFloat(h.opera.version()) ? a = k.body.clientHeight :
                    h.innerHeight && (a = h.innerHeight);
                this.isIE() && (a = k.documentElement.clientHeight);
                return a
            },
            isIE: function() { if (/MSIE (\d+\.\d+);/.test(m.userAgent)) { var a = Number(RegExp.$1); if (9 > a) return a } return !1 },
            getPPI: function() {
            ...
            findWidgets: function() { for (var a = 0, b = [], c = [], d = k.getElementsByTagName("div"), e = k.getElementsByTagName("a"); e[a];) e[a] && (b[a] = e[a]), a++; for (a = 0; d[a];) d[a] && (c[a] = d[a]), a++; for (a = 0; c[a] || b[a];) c[a] && this.addWidget(c[a]), b[a] && this.addWidget(b[a]), a++ },
            addWidget: function(a, b) {
                var c = a.id,
                    d = a.getAttribute("data-uloginid"),
                    e = {},
                    f = !1;
                "undefined" !== typeof h.uLoginParams && (h.uLoginParams[c] ?
                    e = h.uLoginParams[c] : h.uLoginParams[d] ? e = h.uLoginParams[d] : 0 < this.arrayIntersectKey(h.uLoginParams, this.availableParams).length && (e = h.uLoginParams, f = !0));
                b && (e = this.extend(e, b));
            ...
            setProp: function(a, b, c) {
                ...
                if (this.ids[b].providers) {
                    ...
                    var f = [];
                    for (d in e) { var h = e[d]; - 1 < this.inArray(h, this.providerCodes) && f.push(h) }
                ...
                this.ids[b].callback && !this.ids[b].altway &&
            ...
            fixSiteLink: function(a) { a && (/^https?:\/\/(.*?)/.test(a) || (/^\//.test(a) || (a = "/" + a), a = location.origin + a), (new RegExp("^" + location.origin)).test(a) || (a = "", console.error("uLogin ERROR: resource link is invalid, not match with location.origin")), a && (a = this.is_encoded(a) ? a.replace(/\//g, "%2F").replace(/\?/g, "%3F") : encodeURIComponent(a))); return a },
            ...
            initPanel: function(a) {
                var b = this.get(this.ids[a].id),
                    ...
                    w = "",
                    p = "";
                this.ids[a].icons_16 && c ? w = decodeURIComponent(this.ids[a].icons_16) : this.ids[a].icons_32 && !c ? w = decodeURIComponent(this.ids[a].icons_32) : (p = 120 < this.getPPI() ? c ? 32 : 64 : c ? 16 : 32,
                    w = "providers-{size}-{theme}.png?version=img.3.0.1".replace("{size}", p).replace("{theme}", this.ids[a].theme), w = this.buildUrl("version/3.0/img/" + w), p = "smiles-{size}.png?version=img.3.0.1".replace("{size}", p).replace("{theme}", this.ids[a].theme), p = this.buildUrl("img/" + p), this.ids[a].hovered_sprite = p);
                ...
                if ("other" === this.ids[a].hidden) {
                    ...
                    if (this.ids[a].providers) {
                        ...
                        for (var r =
                                0; r < p.length; r++) { var t = this.inArray(p[r], m); - 1 !== t && m.splice(t, 1) }
                    }
                    this.ids[a].hidden = m.toString()
                }
                if (this.ids[a].providers) {
                    p = "relevant" === this.ids[a].sort ? this.relProviders(this.ids[a].providers, this.ids[a].hidden, 1) : this.ids[a].providers.split(",");
                    var B;
                    f += d * ("inset" === this.ids[a].hidden_button && 0 < this.ids[a].hidden.length ? p.length + 1 : p.length);
                ...
                this.ids[a].hidden &&
                    (b.style.position = "relative", "relevant" === this.ids[a].sort && (this.ids[a].hidden = this.relProviders(this.ids[a].providers, this.ids[a].hidden, 2).join(",")), this.ids[a].drop = k.createElement("div"), this.ids[a].drop.className = "ulogin-dropdown-button", this.resetStyle(this.ids[a].drop, { width: e, height: e, margin: "0 " + h + "px " + h + "px 0", cursor: "pointer", background: w, verticalAlign: "baseline", display: "inline-block", "float": "none", backgroundSize: z }), this.ids[a].mobile || (this.add(this.ids[a].drop, "mouseover", function(b) {
                        ...
                        uLogin.setOpacity(b)
                    }), this.add(this.ids[a].drop, "click", function() { uLogin.dropdown(a, c ? 1 : 2) })), "inset" === this.ids[a].hidden_button && this.ids[a].buttonsContainer ? this.ids[a].buttonsContainer.appendChild(this.ids[a].drop) : b.appendChild(this.ids[a].drop), this.ids[a].mobile || this.initDrop(a));
                this.ids[a].buttonsContainer &&
                    0 < this.ids[a].buttonsContainer.clientHeight && (this.ids[a].buttonsContainer.style.height = this.ids[a].buttonsContainer.clientHeight - h + "px");
            ...
            initWindow: function(a) {
                ...
                c.length ? b = c[0] : b.innerHTML ? (c = document.createElement("span"), c.innerHTML = b.innerHTML, b.innerHTML = "", b = b.appendChild(c)) : (c = k.createElement("img"), c.setAttribute("src", this.buildUrl("img/button.png?version=img.3.0.1")),
                    c.setAttribute("style", "cursor:pointer; width:187px; height:30px"), c.setAttribute("alt", "\u041c\u0443\u043b\u044c\u0442\u0438\u0412\u0445\u043e\u0434"), b = b.appendChild(c));
                    ...
                    t(function() {
                        if (a.pixel) {
                            var b = k.createElement("iframe"),
                                c = a.getRC();
                            b.src = a.pixel.replace("[rand]", parseInt(1E5 * Math.random())).replace("[u]",
                                encodeURIComponent(location.href)).replace("[r]", encodeURIComponent(k.referrer || ""));
                            b.width = b.height = 1;
                            b.style.display = "none";
                            c.appendChild(b);
                            t(function() { c.removeChild(b) }, 3E3);
                            a.pixel = !1
                        }
                    }, 0)
                }
            ...
            mergeAccounts: function(a, b) {
                ...
                var c = { token: a };
                b ? ("undefined" !== typeof b.join &&
                    (b = b.join(",")), c.identities = encodeURIComponent(b), c = this.buildUrl("merge_accounts.php", c)) : c = this.buildUrl("require_verify.php", c);
                this.loadWindow(c)
            },
            getRC: function() {
                var a = document.getElementById("ulogin_receiver_container");
                a || (a = k.createElement("div"), a.setAttribute("id", "ulogin_receiver_container"), this.resetStyle(a, { width: 0, height: 0, display: "none" }), k.getElementsByTagName("body")[0].appendChild(a));
                return a
            },
            clearTimeouts: function() { for (var a in this.timeouts) clearTimeout(this.timeouts[a]) },
            callbackTryCall: function(a, b) {
                this.altwayCalled.push(a);
                h[a] ? setTimeout(function() { h[a].call(h, b) }, 10) : setTimeout(function() { uLogin.callbackTryCall(a, b) }, 100)
            },
            callbackReceived: function() {
                ...
                if ((a = this.parse(a)) && a.ulogin_callback && a.ulogin_token && -1 === this.inArray(a.ulogin_callback, this.altwayCalled) && (this.callbackTryCall(a.ulogin_callback, a.ulogin_token), this.supportHistory)) {
                    ...
                    t(function() { window.history.pushState({}, b, c) }, 1E3)
                }
            },
            ...
            initSocket: function(a, b, c, d) {
                ...
                var e = new easyXDM.Socket({
                    ...
                    onMessage: function(a) {
                        ...
                        if (b = a.match(/^(.*?):(.*?)$/)) { var f = b[1]; var k = b[2] }
                        /^https?:\/\//.test(a) ? location.href = a : /^\/auth.php\?/.test(a) ? (a = "https://" + uLogin.uLoginHost + a, uLogin.ids[d].altway ? location.href = a : uLogin.openWithReceiver(a, d)) : -1 < uLogin.inArray(a, uLogin.states) ? uLogin._changeState(d, a) : f && -1 < uLogin.inArray(f,
                            ...
                            "undefined" != typeof h[uLogin.ids[d].callback] && (uLogin._changeState(d, "receive"), h[uLogin.ids[d].callback](a), uLogin.dialog && uLogin.hideAll())
                    }
                });
                return e
            },
            ...
            onMoveWindow: function() { this.moveWindow() },
            loadWindow: function(a, b) {
                null === b && (b = !1);
                var c = this.ids[b] ? this.ids[b].opacity : 75;
                try { k.body.removeChild(this.lightbox) } catch (e) {}
                try { k.body.removeChild(this.dialog) } catch (e) {}
                var d = k.createElement("div");
                this.resetStyle(d, { position: "fixed", zIndex: 9997, width: "100%", height: "100%", background: "#" + (this.ids[b] ? this.ids[b].color : "fff"), display: "none" });
                this.setOpacity(d, c);
                this.lightbox = d;
                d = k.createElement("div");
                d.id = this.genID();
                ...
                this.add(this.lightbox, "click", function() { uLogin.hideAll() });
                this.add(this.close, "click", function() { uLogin.hideAll() });
                this.add(this.close, "mouseover", function(a) { a.style.background = "url(" + uLogin.buildUrl("img/x_.png") + ")" });
                this.add(this.close, "mouseout", function(a) { a.style.background = "url(" + uLogin.buildUrl("img/x.png") + ")" });
                this.add(h, "scroll", function() { uLogin.onMoveWindow() });
            ...
            resetStyle: function(a, b) {
                ...
                var c = this.extend({
                    ...
                    e = ["float"],
                    f;
                for (f in c) {-1 < this.inArray(f, d) && "number" === typeof c[f] && (c[f] += "px"); try {-1 < this.inArray(f, e) && a.style.setProperty(f, c[f]) } catch (n) {} try { a.style[f] = c[f] } catch (n) {} }
            },
            getIconPosition: function(a, b) { return a ? "0 -" + (18 + 17 * b) + "px" : "0 -" + (36 + 34 * b) + "px" },
            ...
            initDrop: function(a) {
                if (!this.ids[a].mobile && "" != this.ids[a].hidden) {
                    ...
                    this.resetStyle(e, { position: "absolute", background: "#000", left: "initial", right: "flat" === this.ids[a].theme ? "-3px" : "-5px", top: "100%", width: 41, height: 13, border: "flat" === this.ids[a].theme ? "3px solid #666" : "5px solid #666", textAlign: "center" });
                    d = k.createElement("a");
                    d.href = this.buildUrl("");
                    d.target = "_blank";
                    this.resetStyle(d, { width: 41, height: 13, background: "url(" + this.buildUrl("img/text.png") + ") no-repeat" });
                    e.appendChild(d);
                    this.ids[a].hiddenW.appendChild(e);
                    e = k.createElement("div");
                    this.resetStyle(e, { width: 0, height: 0, position: "absolute", zIndex: 9999, display: "none", border: "5px solid transparent", borderBottomColor: "#666" });
                    this.ids[a].hiddenA = e;
                    b.appendChild(this.ids[a].hiddenA);
                    this.ids[a].showed = !1;
                    this.add(k.body, "click", function(a, b) { b.target || (b.target = b.srcElement); for (var c = 0; c < uLogin.ids.length; c++) b.target != uLogin.ids[c].drop && (uLogin.hide(uLogin.ids[c].hiddenW), uLogin.hide(uLogin.ids[c].hiddenA)) });
                    this.ids[a].hiddenW && this.ids[a].hiddenA && (this.add(this.ids[a].hiddenW,
                        "mouseout",
                        function() { uLogin.dropdownDelayed(a, 0) }), this.add(this.ids[a].hiddenA, "mouseout", function() { uLogin.dropdownDelayed(a, 0) }), this.add(this.ids[a].hiddenW, "mouseover", function() { uLogin.clearDropTimer(a) }), this.add(this.ids[a].hiddenA, "mouseover", function() { uLogin.clearDropTimer(a) }))
                }
            },
                ...
                if (this.ids[a].hiddenW || this.ids[a].hiddenA)
                    if (this.ids[a].showed || 0 == b) this.hide(this.ids[a].hiddenW), this.hide(this.ids[a].hiddenA), this.ids[a].showed = !1;
                        ...
                        "body" !== this.ids[a].dropdown_container && (this.ids[a].hiddenW.style.left =
                            e - (1 == b ? 100 : 106) + "px", this.ids[a].hiddenW.style.top = d + (1 == b ? 21 : 37) + "px");
                        this.ids[a].hiddenA.style.left = e + (1 == b ? 4 : 12) + "px";
                        this.ids[a].hiddenA.style.top = d + (1 == b ? 12 : 28) + "px"
                    }
            },
            clearDropTimer: function(a) { this.ids[a].dropTimer && h.clearTimeout(this.ids[a].dropTimer) },
            dropdown: function(a, b) { this.ids[a].mobile || (this.clearDropTimer(a), this.showDrop(a, b)) },
            dropdownDelayed: function(a, b) {
                this.clearDropTimer(a);
                this.ids[a].dropTimer = t(function() { uLogin.showDrop(a, b) }, 600)
            },
            ...
            _: function(a) { return function() { a.apply(uLogin, arguments) } },
            ...
            _initButton: function(a, b) {
                ...
                if (c)
                    if (-1 < this.inArray(c, this.providerCodes)) this.add(a, "mouseover", function(a) {
                        ...
                        setTimeout(function() { a.setAttribute("data-disabled-click", "") }, 1E3);
            ...
            randFromTo: function(a, b) { return Math.floor(Math.random() * b) + a },
            sendWeight: function(a) { this.initSocket(this.buildUrl("version/3.0/html/weight_set.html", { provider: a, r: parseInt(1E5 * Math.random()) }), this.getRC(), { background: "transparent" }) },
            setWeights: function(a) { this.supportStorage && (localStorage.providers_weight = a) },
            getWeights: function() { try { return JSON.parse(localStorage.providers_weight) } catch (a) { return {} } },
            relProviders: function(a, b, c) {
                ...
                if (this.supportStorage) {
                    var d =
                        this.getWeights(),
                        e;
                    for (e in d) { d = this.inArray(e, a); var f = this.inArray(e, b); - 1 !== d ? (a.splice(d, 1), a.splice(0, 0, e)) : -1 !== f && (a.splice(0, 0, e), b.splice(f, 1), b.splice(0, 0, a[a.length - 1]), a.splice(a.length - 1, 1)) }
                }
                return 1 === c ? a : b
            },
            ...
            openWithReceiver: function(a, b) {
                ...
                }), this.getRC(), { background: "transparent" }, b), uLogin.getRC().getElementsByTagName("iframe"), window.open(a, "uLogin_window", "width=" + c + ",height=" + d + ",left=" + (screen.width - c) / 2 + ",top=" + (screen.height - d) / 2))
            },
            checkWindow: function(a, b) {},
            checkCurrentWidgets: function() { for (var a = 0; this.ids[a];) this.checkWidget(this.ids[a++].id) },
            ...
            buildUrl: function(a, b, c) {
                ...
                for (e in b) {
                    var f = b[e];
                    null !== f && (!c && (/\?/.test(f) || /\//.test(f) || /:/.test(f)) && (f = ""), d += e + "=" + f + "&")
                }
            ...
            getOffsetSum: function(a) { for (var b = 0, c = 0; a;) b += parseFloat(a.offsetTop), c += parseFloat(a.offsetLeft), a = a.offsetParent; return { top: Math.round(b), left: Math.round(c) } },
            getOffsetRect: function(a) {
                a = a.getBoundingClientRect();
                var b = document.body,
                    c = document.documentElement;
                return { top: Math.round(a.top + (window.pageYOffset || c.scrollTop || b.scrollTop) - (c.clientTop || b.clientTop || 0)), left: Math.round(a.left + (window.pageXOffset || c.scrollLeft || b.scrollLeft) - (c.clientLeft || b.clientLeft || 0)) }
            },
            ...
            removeStateListener: function(a, b, c) { return this.listeners[a] && this.listeners[a][c] ? this.listeners[a][c].splice(b, 1) : !1 },
            ...
            extend: function(a, b) { for (var c in b) a[c] = b[c]; return a },
