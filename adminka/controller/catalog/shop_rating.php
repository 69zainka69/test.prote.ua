...
class ControllerCatalogShopRating extends Controller {
    ...
    public function index() {
        ...
        $data['title_goods'] = $this->language->get('title_goods');
        ...
        $data['delete_link'] = $this->url->link('catalog/shop_rating/delete', 'token=' . $this->session->data['token'], 'SSL');
    ...
    public function viewRate(){
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if(isset($this->request->post['answer']) && $this->request->post['answer'] != '') {
                $this->model_catalog_shop_rating->addAnswer($rate_id, $this->request->post, $this->session->data['user_id']);
            }
