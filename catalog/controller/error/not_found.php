...
//        /$this->request->server['REQUEST_URI']!='/page-error/'
        $allow_page = array('/page-error/','/ua/page-error/');
        if(!in_array($this->request->server['REQUEST_URI'],$allow_page )){
