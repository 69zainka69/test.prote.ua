...
{
  echo "<h3>".$catfive."</h3>";
foreach ($prodfive as $namefive){
  echo "<p>".$namefive."</p>";
}}
if(isset($catsix))
{
  echo "<h3>".$catsix."</h3>";
foreach ($prodsix as $namesix){
  echo "<p>".$namesix."</p>";
}}
if(isset($catseven))
{
  echo "<h3>".$catseven."</h3>";
foreach ($prodseven as $nameseven){
  echo "<p>".$nameseven."</p>";
}}
if(isset($cateight))
{
  echo "<h3>".$cateight."</h3>";
foreach ($prodeight as $nameseven){
  echo "<p>".$nameseven."</p>";
}}
if(isset($catnine))
{
  echo "<h3>".$catnine."</h3>";
foreach ($prodnine as $nameseven){
  echo "<p>".$nameseven."</p>";
}}
if(isset($catten))
{
  echo "<h3>".$catten."</h3>";
foreach ($prodten as $nameseven){
  echo "<p>".$nameseven."</p>";
}}
if(isset($catelew))
{
  echo "<h3>".$catelew."</h3>";
foreach ($prodelew as $nameseven){
  echo "<p>".$nameseven."</p>";
}}
if(isset($cattwel))
{
  echo "<h3>".$cattwel."</h3>";
foreach ($prodtwel as $nameseven){
  echo "<p>".$nameseven."</p>";
}}
if(isset($catsert))
{
  echo "<h3>".$catsert."</h3>";
foreach ($prodsert as $nameseven){
  echo "<p>".$nameseven."</p>";
}}
if(isset($catfort))
{
  echo "<h3>".$catfort."</h3>";
foreach ($prodfort as $nameseven){
  echo "<p>".$nameseven."</p>";
}}
?>
