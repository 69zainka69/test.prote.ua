    ...
    <tbody>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_order_id; ?></b> <?php echo $order_id; ?><br />
          ...
          <b><?php echo $text_new_company; ?></b> <?php echo $shipping_company; ?><br />
          <?php } ?>
          <?php if ($company_name) { ?>
          <b><?php echo $text_new_company_name; ?></b> <?php echo $company_name; ?><br />
          <?php } ?>
          <?php if ($no_call) { ?>
          <b><?php echo $text_new_no_clall; ?></b> <br /><?php echo $text_new_no_call_tooltip; ?>
          <?php } ?>
        </td>
