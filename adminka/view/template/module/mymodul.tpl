      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><select name="mymodul_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="left"><select name="mymodul_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="right"><input type="text" name="mymodul_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
