...
$GFEED = url_get_contents("https://prote.ua/index.php?route=feed/googlebase");
...
$file=fopen("/var/www/prote/data/www/prote.ua/exec/google/googlemerchant.xml", "w+");
fputs($file,$newphrase);
fclose($file);


header("Location: https://prote.ua/exec/google/googlemerchant.xml");
exit();
