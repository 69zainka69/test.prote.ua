            ...
            <tbody>
              ...
              <tr id="filter-row<?php echo $filter_row; ?>">
                <td class="text-left" style="width: 70%;">
                  filter_id = <input type="text" readonly name="filter[<?php echo $filter_row; ?>][filter_id]" value="<?php echo $filter['filter_id']; ?>" />
                  ext_filter_id = <input type="text" readonly name="filter[<?php echo $filter_row; ?>][ext_filter_id]" value="<?php echo $filter['ext_filter_id']; ?>" />
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
