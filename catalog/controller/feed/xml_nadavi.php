<?php
class ControllerFeedXmlNadavi extends Controller {
    ...
    public function index() {
        ...
        $output  = '<?xml version="1.0" encoding="UTF-8"?>' . "\n" 
                . '<yml_catalog date="' . $this->datestamp . '" >'
                . '<shop>' . "\n"                 
                . '<name>' . $this->firmname . '</name>' . "\n" 
                . '<url>'  . $this->firmurl  . '</url>' . "\n" 
                . '<currencies>'
