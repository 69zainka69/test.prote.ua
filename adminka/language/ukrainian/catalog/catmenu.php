...
$_['help_keyword']           = 'Має бути унікальним на усю систему.';
$_['help_top']               = 'Показувати в головному меню (тільки для головних батьківських категорій).';
$_['help_column']            = 'Кількість стовпців у випадному меню категорії (тільки для головних батьківських категорій)';

// Error
$_['error_warning']          = 'Уважно перевірте форму на помилки!';
$_['error_permission']       = 'Ви не маєте повноважень для зміни категорій!';
