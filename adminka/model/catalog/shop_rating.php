...
class ModelCatalogShopRating extends Model {
	...
	public function addAnswer($rate_id, $answer, $user_id)
	{
	...
	public function install() {
		$this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "shop_rating` (
			  ...
			  `planing_buy` INT(1) NOT NULL,
			  `shop_rate` INT(1) DEFAULT NULL,
			  `site_rate` INT(1) DEFAULT NULL,
			  `service_rate` INT(1) NOT NULL,
			  `delivery_rate` INT(1) NOT NULL,
			  `goods_rate` INT(1) NOT NULL,
		...
		$this->db->query("
			INSERT INTO `" . DB_PREFIX . "url_alias` (query, keyword, date_added) VALUES ('information/shop_rating', 'otzivi', '2021-05-20 13:09:30')
		");
