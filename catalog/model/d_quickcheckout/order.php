...
class ModelDQuickcheckoutOrder extends Model {
    ...
    public function addOrder($data) {
        ...
        if(!isset($data['no_call']))$data['no_call']=5;
    ...
    public function updateOrder($order_id, $data) {
        ...
        if(!isset($data['no_call']))$data['no_call']=6;
        ...
        if($this->db->escape($data['shipping_code'])=="novaposhta.novaposhta"){
        $query .= "payment_method = '" . $this->db->escape($data['payment_method']) . "', 
            ...
            shipping_address_2 = '" . (isset($this->session->data['shipping_method']['npfullpath']) ?  $this->db->escape($this->session->data['shipping_method']['npfullpath']) : $this->db->escape($data['shipping_address_2'])) . "',
        ...
        if($this->db->escape($data['shipping_code'])=="justin.justin"){
            $query .= "payment_method = '" . $this->db->escape($data['payment_method']) . "', 
            payment_code = '" . $this->db->escape($data['payment_code']) . "', 
            shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) . "', 
            shipping_lastname = '" . $this->db->escape($data['shipping_lastname']) . "', 
            ...
            shipping_address_1 = '" . $this->db->escape($data['shipping_address_1']) . "', 
            shipping_address_2 = '" . $this->db->escape($data['shipping_address_2']) . "',
            shipping_address_2 = '" . (isset($this->session->data['shipping_method']['justfullpath']) ?  $this->db->escape($this->session->data['shipping_method']['justfullpath']) : $this->db->escape($data['shipping_address_2'])) . "',
            shipping_city = '" . $this->db->escape($data['shipping_city']) . "', 
            shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) . "', 
            shipping_country = '" . $this->db->escape($data['shipping_country']) . "', 
            shipping_country_id = '" . (int) $data['shipping_country_id'] . "', 
        ...
        if($this->db->escape($data['shipping_code'])=="meest.meest"){
            $query .= "payment_method = '" . $this->db->escape($data['payment_method']) . "', 
            payment_code = '" . $this->db->escape($data['payment_code']) . "', 
            shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) . "', 
            shipping_lastname = '" . $this->db->escape($data['shipping_lastname']) . "', 
            ...
            shipping_address_1 = '" . $this->db->escape($data['shipping_address_1']) . "', 
            shipping_address_2 = '" . $this->db->escape($data['shipping_address_2']) . "',
            shipping_address_2 = '" . (isset($this->session->data['shipping_method']['meestfullpath']) ?  $this->db->escape($this->session->data['shipping_method']['meestfullpath']) : $this->db->escape($data['shipping_address_2'])) . "',
            shipping_city = '" . $this->db->escape($data['shipping_city']) . "', 
            shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) . "', 
            shipping_country = '" . $this->db->escape($data['shipping_country']) . "', 
            shipping_country_id = '" . (int) $data['shipping_country_id'] . "', 
 ...
 // file_put_contents('/var/www/prote.com.ua/jj.log', '>'. $query, FILE_APPEND); die();
