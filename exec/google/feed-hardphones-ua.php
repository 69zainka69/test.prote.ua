...
$output  = '<?xml version="1.0" encoding="UTF-8" ?>';
			...
			$output .= '<channel>';
			$output .= '<title>Prote - навушники та гарнітури, канцтовари, картриджі, папір, чорнило. Все, що потрібне офісу.</title>';
    ...
    $lang = 2;
    $brand = 'Logitech';
    $prods = array("11865", "30737");


    $breadcr = "Головна > Комп'ютери та аксесуари > Навушники та гарнітури";
...
$file=fopen("/var/www/prote/data/www/prote.ua/exec/google/feed-hardphones-ua.xml", "w+");
fputs($file,$output);
fclose($file);


header("Location: https://prote.ua/exec/google/feed-hardphones-ua.xml");
exit();
