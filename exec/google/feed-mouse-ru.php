...
$output  = '<?xml version="1.0" encoding="UTF-8" ?>';
			...
			$output .= '<channel>';
			$output .= '<title>Prote – компьютерная мышь, канцтовары, картриджи, бумага, чернила. Все, что нужно офису.</title>';
    ...
    $breadcr = "Главная > Компьютеры и аксессуары > Компьютерная мышь";
...
$file=fopen("/var/www/prote/data/www/prote.ua/exec/google/feed-mouse-ru.xml", "w+");
fputs($file,$output);
fclose($file);


header("Location: https://prote.ua/exec/google/feed-mouse-ru.xml");
exit();
