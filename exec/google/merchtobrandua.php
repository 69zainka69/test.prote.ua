...
$bran = ['Hewlett Packard', 'HP','Pantum'];
$cattwo = 82;
...
$output .= "<link>https://prote.ua/ua/".$link.".html</link>";
...
$output .= "<g:product_type>Головна > Офісна техніка > Лазерні принтери</g:product_type>";
...
$file=fopen("/var/www/prote/data/www/prote.ua/exec/google/merchbrandua.xml", "w+");
fputs($file,$output);
fclose($file);


header("Location: https://prote.ua/exec/google/merchbrandua.xml");
exit();
