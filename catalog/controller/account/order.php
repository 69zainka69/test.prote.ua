	...
	public function index() {
		...
		foreach ($results as $result) {
			...
			$data['orders'][] = array(
				...
				'order_reorder' => $this->url->link('account/order/reorder', 'order_id=' . $result['order_id'], true),
	...
	public function reorder() {
		...
		if ($order_info) {
			...
			foreach ($products as $product) {
				...
				$order_product_info = $this->model_account_order->getOrderProduct($order_id, $product['order_product_id']);
				...
				if ($order_product_info) {
					...
					if ($product_info) {
						...
						$this->session->data['success'] = sprintf($this->language->get('text_success2'), $this->url->link('checkout/cart'));
