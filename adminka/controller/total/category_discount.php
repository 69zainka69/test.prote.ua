...
class ControllerTotalCategoryDiscount extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('total/category_discount', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('total/category_discount.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'total/category_discount')) {
