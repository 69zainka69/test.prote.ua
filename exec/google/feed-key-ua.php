...
$output  = '<?xml version="1.0" encoding="UTF-8" ?>';
			...
			$output .= '<channel>';
			$output .= '<title>Prote - клавіатури набори, канцтовари, картриджі, папір, чорнило. Все, що потрібне офісу.</title>';
    ...
    $lang = 2;
    $brand = 'Logitech';
    $prods = array("4011", "13008", "12981", "4014");


    $breadcr = "Головна > Комп'ютери та аксесуари > Клавіатури";
...
$file=fopen("/var/www/prote/data/www/prote.ua/exec/google/feed-key-ua.xml", "w+");
fputs($file,$output);
fclose($file);


header("Location: https://prote.ua/exec/google/feed-key-ua.xml");
exit();
