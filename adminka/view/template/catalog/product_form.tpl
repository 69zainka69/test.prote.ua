        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-axdescription<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_axdescription; ?>"><?php echo $entry_axdescription; ?></span></label>
                    <div class="col-sm-10">
                      <textarea readonly name="product_description[<?php echo $language['language_id']; ?>][axdescription]" rows="8" id="input-axdescription<?php echo $language['language_id']; ?>" class="form-control" /><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['axdescription'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-seo_text<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="seo_text">seo_text</span></label>
                    <div class="col-sm-10">
                      <textarea readonly name="product_description[<?php echo $language['language_id']; ?>][seo_text]" rows="8" id="input-seo_text<?php echo $language['language_id']; ?>" class="form-control" /><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['seo_text'] : ''; ?></textarea>
                    </div>
                  </div>
                </div>
                <?php } ?>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-video"><span data-toggle="tooltip" title="Видео с youtube">Видео</span></label>
                <div class="col-sm-10">
                  <textarea name="video" rows="4" placeholder="Код youtube" id="input-video" class="form-control"><?php echo $video; ?></textarea>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_is_complex; ?></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($is_complex) { ?>
                    <input type="radio" name="is_complex" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="is_complex" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$is_complex) { ?>
                    <input type="radio" name="is_complex" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="is_complex" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-delivery_days"><?php echo $entry_delivery_days; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="delivery_days" value="<?php echo $delivery_days; ?>" placeholder="<?php echo $entry_delivery_days; ?>" id="input-delivery_days" class="form-control" />
                </div>
              </div>
            </div>
