...
$gro = array_unique($gro);
$gros = array_unique($gros);
$grosea = array_unique($grosea);
$grose = array_unique($grose);
}
                ...
                if ($result['news']) {
					...
					if(!isset($this->request->get['category_id'])){
						if(isset($truesearch)){
							...
							$data['prodtwo'] = $gros;
							$data['cattwo'] = $groups;
							$data['prodthree'] = $grose;
							$data['catthree'] = $groupse;
							$data['prodfour'] = $grosea;
							$data['catfour'] = $groupsea;
						}
					}
