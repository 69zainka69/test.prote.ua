...
$('input[name=\'google_base_category\']').autocomplete({
    'source': function(request, response) {
        $.ajax({
            url: 'index.php?route=feed/google_baseru/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
            dataType: 'json',
...
$('#category').load('index.php?route=feed/google_baseru/category&token=<?php echo $token; ?>');

$('#button-category-add').on('click', function() {
	$.ajax({
		url: 'index.php?route=feed/google_baseru/addcategory&token=<?php echo $token; ?>',
		type: 'post',
		dataType: 'json',
...
$('#category').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: 'index.php?route=feed/google_baseru/removecategory&token=<?php echo $token; ?>',
		type: 'post',
...
$('#button-import').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: 'index.php?route=feed/google_baseru/import&token=<?php echo $token; ?>',
				type: 'post',
				dataType: 'json',
