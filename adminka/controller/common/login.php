...
class ControllerCommonLogin extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			// если логинимся и получаем apiKey = get_api отдаем токен
			// делалось для очистки кеша BrainFilter после импорта
			if(isset($this->request->post['apiKey'])&&$this->request->post['apiKey']=='get_api'){
