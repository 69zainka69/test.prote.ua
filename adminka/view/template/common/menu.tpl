<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $informal; ?>"><?php echo $text_informal; ?></a></li>
      <li><a href="<?php echo $workers; ?>">Заказ товаров по количеству сотрудников</a></li>
      <li><a href="<?php echo $product; ?>"><?php echo $text_product; ?></a></li>
      <li><a href="index.php?route=module/productbundles&token=<?php echo $_GET['token']; ?>">Product Bundles</a></li>
      <li><a href="<?php echo $catmenu; ?>"><?php echo $text_catmenu; ?></a></li>
      <li><a href="<?php echo $question; ?>">Вопросы/Ответы</a></li>
      <li><a href="<?php echo $recurring; ?>"><?php echo $text_recurring; ?></a></li>
      <li><a href="<?php echo $filter; ?>"><?php echo $text_filter; ?></a></li>
      <li><a href="<?php echo $filter_seodata; ?>"><?php echo $text_filter_seodata; ?></a></li>
      <li><a href="<?php echo $puseo; ?>"><?php echo $text_filter_seopu; ?></a></li>
      <li><a href="<?php echo $filterseo; ?>"><?php echo $text_filter_seodata; ?> new</a></li>
      ...
      <li><a href="<?php echo $site_rating; ?>"><?php echo $text_site_rating; ?></a></li>
      <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
      <li><a href="<?php echo $news; ?>"><?php echo $text_actions; ?></a></li>
      <li><a href="<?php echo $articles; ?>"><?php echo $text_articles; ?></a></li>
      <li><a class="parent">Скидки</a>
        <ul>
          <li><a href="<?php echo $discount_category; ?>"><?php echo $text_category_discount; ?></a></li>
          <li><a href="<?php echo $discount_customer_group; ?>"><?php echo $text_customer_group_discount; ?></a></li>
          <li><a href="<?php echo $discount_manufacturer; ?>"><?php echo $text_manufacturer_discount; ?></a></li>
          <li><a href="<?php echo $discount_ordertotal; ?>"><?php echo $text_ordertotal_discount; ?></a></li>
          <li><a href="<?php echo $discount_volume; ?>"><?php echo $text_volume_discount; ?></a></li>
          <li><a href="<?php echo $discount_loyalty; ?>"><?php echo $text_loyalty_discount; ?></a></li>
        </ul>
      </li>
