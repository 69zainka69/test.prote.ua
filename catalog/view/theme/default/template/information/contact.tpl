...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <p class="h3"><?php echo $text_location; ?></p>
      ...
      <?php if ($locations) { ?>
      <p class="h3"><?php echo $text_store; ?></p>
      <div class="panel-group" id="accordion">
        <?php foreach ($locations as $location) { ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <p class="h4" class="panel-title"><a href="#collapse-location<?php echo $location['location_id']; ?>" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"><?php echo $location['name']; ?> <i class="fa fa-caret-down"></i></a></p>
          </div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons">
          <div class="pull-right">
            <input class="btn btn-primary btn-blue-shadow" type="submit" value="<?php echo $button_submit; ?>" />
          </div>
        </div>
      </form>
