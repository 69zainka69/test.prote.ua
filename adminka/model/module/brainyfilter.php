...
class ModelModuleBrainyFilter extends Model 
{
    ...
    {   file_put_contents('/var/www/prote/data/www/prote.ua/uuuppp.log', 'createAttributeValueTable: '.date('H:i:s')."\n", FILE_APPEND);
    ...
    {   
        // file_put_contents('/var/www/prote/data/www/prote.ua/uuuppp.log', 'filfilters: '.date('H:i:s')."\n", FILE_APPEND);
        $sql = new SqlStatement();
        ...
        $this->db->query($sql);
        // $this->db->query($sql);
        file_put_contents('/var/www/prote/data/www/prote.ua/uuuppp.log', 'filfilters done: '.date('H:i:s')."\n", FILE_APPEND);
    }
    ...
    public function updateProductAttributes()
    {
        ...
        $res = $this->db->query($getAttrSql->limit(10000, $step * 10000));
         ...
         while (count($res->rows)) {
            ...
            $step ++;
            file_put_contents('/var/www/prote/data/www/prote.ua/uuuppp.log', date('H:i:s').$step."-step\n", FILE_APPEND);
            $res = $this->db->query($getAttrSql->limit(10000, $step * 10000));
        }
    ...
    {   file_put_contents('/var/www/prote/data/www/prote.ua/uuuppp.log', 'recoverAttributeValues: '.date('H:i:s')."\n", FILE_APPEND);
        ...
        $this->dropAttributeValueTableBackup();
        file_put_contents('/var/www/prote/data/www/prote.ua/uuuppp.log', 'recoverAttributeValues: done'.date('H:i:s')."\n", FILE_APPEND);
    }
