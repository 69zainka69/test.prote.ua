...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['text_informal'] = $this->language->get('text_informal');
		...
		$data['text_filter_seodata'] = $this->language->get('text_filter_seodata');
		$data['text_filter_seopu'] = $this->language->get('text_filter_seopu');
		...
		$data['text_site_rating'] = $this->language->get('text_site_rating');
        ...
        $data['informal'] = $this->url->link('catalog/informal', 'token=' . $this->session->data['token'], 'SSL');
        $data['workers'] = $this->url->link('catalog/workers', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['catmenu'] = $this->url->link('catalog/catmenu', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['filter_seodata'] = $this->url->link('catalog/filter_seodata', 'token=' . $this->session->data['token'], 'SSL');
		$data['filterseo'] = $this->url->link('catalog/filterseo', 'token=' . $this->session->data['token'], 'SSL');
		$data['puseo'] = $this->url->link('catalog/puseo', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['site_rating'] = $this->url->link('catalog/shop_rating', 'token=' . $this->session->data['token'], 'SSL');
