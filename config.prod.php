...
define('HTTP_SERVER', 'https://prote.ua/');
define('HTTPS_SERVER', 'https://prote.ua/');
define('HTTPS_SERVER_ADMIN', 'https://prote.ua/adminka/');
...
define('DB_HOSTNAME', '127.0.0.1');
define('DB_USERNAME', 'prote');
define('DB_PASSWORD', '7B6a2S6t');
// define('DB_DATABASE', 'prote.ua');
// define('DB_USERNAME', 'maxssx');
// define('DB_PASSWORD', 'maximka12344');
define('DB_DATABASE', 'prote.ua');
//define('DB_PORT', '3311'); //mysql 5.7.29
//define('DB_PORT', '3310'); //mysql 8.0.19
define('DB_PORT', '3317'); //mysql 8.0.19
