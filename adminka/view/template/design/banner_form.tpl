          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left" style="width:70px">Язык</td>
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left" style=""><input type="text" name="banner_image[<?php echo $image_row; ?>][lang]" value="<?php echo $banner_image['lang']; ?>" placeholder="Введите язык" class="form-control" /></td>
                ...
                <td class="text-right"><input type="text" name="banner_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $banner_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
                 <td class="text-left" style="width:135px;">
                  <select name="banner_image[<?php echo $image_row; ?>][status]">
...
function addImage() {
  ...
  html += '  <td class="text-left"><input type="text" name="banner_image[' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>'; 
	html += '  <td class="text-left"><input type="text" name="banner_image[' + image_row + '][lang]" value="" placeholder="Введите язык" class="form-control" /></td>';	
  ...
  html += '  <td class="text-left" style="width:135px;">';
  html += '                <select name="banner_image[' + image_row + '][status]">';
